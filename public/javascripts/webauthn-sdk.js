(function (exports) {
    ...
    for (;;) {
      ...
      switch (part[0]) {
        ...
        case "#":
          ...
          break;
        case "[": {
          var attributeMatch = /^\[([\w-]+)([~|^$*]?=("(.*?)"|([\w-]+)))?(\s+[is])?\]$/.exec(
            part
          );
          if (attributeMatch) {
            addAttribute(
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      ...
                      return [
                        4 /*yield*/,
                        forEachWithBreaks(includedSources, function (
                          sourceKey,
                          index
                        ) {
  ...
  function isSdkRejection(rejection) {
    return (
      typeof rejection.errorCode == "string" &&
      typeof rejection.description == "string"
    );
  }
  ...
  var SdkStorage = (function () {
    ...
    SdkStorage.set = function (keyName, value) {
      return SdkStorage.getStorageMedium(
        SdkStorage.allowedKeys[keyName]
      ).setItem(SdkStorage.getStorageKey(keyName), value);
    };
    SdkStorage.clear = function (retainConfiguration) {
      var e_1, _a;
      try {
        for (
          var _b = __values(Object.entries(SdkStorage.allowedKeys)),
            _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          ...
          if (
            (retainConfiguration &&
              this.configurationKeys.includes(typedKey)) ||
    ...
    SdkStorage.getStorageMedium = function (keyPersistance) {
      switch (keyPersistance) {
        case KeyPersistance.persistent:
          return localStorage;
    ...
    DeviceFingerprint.fromStorageEntry = function (entry) {
      ...
      if (!DeviceFingerprint.isDeviceFingerprintProvider(splitted[0])) {
        throw makeSdkRejection(
          ErrorCode.Unknown,
          "Could not identify device fingerprint provider: ".concat(splitted[0])
        );
      }
  ...
  var DeviceFingerprintHandler = (function () {
    function DeviceFingerprintHandler() {
      ...
      this._currentDfps = {
            ...
            return __generator(this, function (_b) {
              switch (_b.label) {
                case 0:
                  return [4, load()];
                case 1:
                  return [4, _b.sent().get()];
                case 2:
                  result = _b.sent();
                  (_a = result.components),
                    _a.fonts,
                    _a.fontPreferences,
                    _a.domBlockers,
                    _a.forcedColors,
                  ...
                  return [
                    ...
                    new DeviceFingerprint(
                      "FPJS",
                      hashComponents(reducedComponents)
                    )
                  ];
              }
            });
        ...
        RiskID: new LazyLoaded(function () {
          return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              throw makeSdkRejection(
                ErrorCode.Unknown,
                "Unsupported device fingerprint provider: RiskID"
              );
            });
          });
        })
    ...
    DeviceFingerprintHandler.prototype.getCurrentFingerprint = function (
      provider
    ) {
      if (provider === void 0) {
        provider = "FPJS";
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this._currentDfps[provider].get()];
            case 1:
              return [2, _a.sent()];
          }
        });
    ...
    DeviceFingerprintHandler.prototype.getStoredFingerprints = function () {
      var _a;
      return JSON.parse(
        (_a = SdkStorage.get("deviceFingerprints")) !== null && _a !== void 0
          ? _a
          : "[]"
      );
    };
    DeviceFingerprintHandler.prototype.getStoredFingerprint = function (
      provider
    ) {
      if (provider === void 0) {
        provider = "FPJS";
      }
      return this.getStoredFingerprints().find(function (dfp) {
        return dfp.provider === provider;
      });
    };
    DeviceFingerprintHandler.prototype.persist = function (provider) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.getCurrentFingerprint(provider)];
            case 1:
              currentDfp = _a.sent();
              storedFingerprints = this.getStoredFingerprints();
              storedFingerprints = storedFingerprints
                .filter(function (dfp) {
                  return dfp.provider !== currentDfp.provider;
                })
                .concat(currentDfp);
              SdkStorage.set(
                "deviceFingerprints",
                JSON.stringify(
                  storedFingerprints.map(function (dfp) {
                    return dfp.stringify();
                  })
                )
              );
              return [2];
  ...
  var SdkBindIdApiClient = (function () {
    ...
    SdkBindIdApiClient.startWebauthnAuthentication = function (
      authSessionId,
      idpUsername
    ) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_o) {
            switch (_o.label) {
              case 0:
                ...
                return [
                  4,
                  SdkBindIdApiClient.getSessionStatus(this.authSessionId)
                ];
              case 1:
                ...
                return [3, 10];
              case 2:
                if (!(currentSessionStatus.cross_device_status == "attached"))
                  return [3, 4];
                return [
                  4,
                  (_b = (_a = this.handlers).onDeviceAttach) === null ||
                  _b === void 0
                    ? void 0
                    : _b.call(_a)
                ];
              case 3:
                ...
                return [3, 10];
              case 4:
                if (!(currentSessionStatus.cross_device_status == "registered"))
                  return [3, 6];
                return [
                  4,
                  (_d = (_c = this.handlers).onCredentialRegister) === null ||
                  _d === void 0
                    ? void 0
                    : _d.call(
                        _c,
                        (_e = currentSessionStatus.cross_device_result) ===
                          null || _e === void 0
                          ? void 0
                          : _e.auth_code
                      )
              ...
              case 6:
                if (
                  !(currentSessionStatus.cross_device_status == "authenticated")
                )
                  return [3, 8];
                return [
                  4,
                  (_g = (_f = this.handlers).onCredentialAuthenticate) ===
                    null || _g === void 0
                    ? void 0
                    : _g.call(
                        _f,
                        (_h = currentSessionStatus.cross_device_result) ===
                          null || _h === void 0
                          ? void 0
                          : _h.auth_code
                      )
              ...
              case 7:
                ...
                return [3, 10];
              case 8:
                if (!(currentSessionStatus.cross_device_status == "completed"))
                  return [3, 10];
                return [
                  4,
                  (_k = (_j = this.handlers).onDeviceDetach) === null ||
                  _k === void 0
                    ? void 0
                    : _k.call(_j)
                ];
              ...
              case 12:
                error_1 = _o.sent();
                logger.error(
                  "error in WebAuthn cross device session polling: ",
                  error_1
                );
                this.destroy();
                (_m = (_l = this.handlers).onFailure) === null || _m === void 0
                  ? void 0
                  : _m.call(_l, ErrorCode.Unknown);
                return [3, 13];
              case 13:
                return [2];
            }
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
          return [
            2,
            JSON.parse(
              (_a = SdkStorage.get("deviceUsers")) !== null && _a !== void 0
                ? _a
                : "[]"
            )
          ];
    ...
    EncodingUtils.arrayBufferToBase64 = function (buffer) {
      return btoa(
        String.fromCharCode.apply(
          String,
          __spreadArray([], __read(new Uint8Array(buffer)), false)
        )
      );
    };
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4,
                  SdkBindIdApiClient.startWebauthnAuthentication(
                    this.authSessionId,
                    username
                  )
                ];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              credentialRequestOptions =
                startAuthenticationResponse.credential_request_options;
            ...
            case 2:
              ...
              encodedCredential = {
                ...
                response: {
                  ...
                  signature: EncodingUtils.arrayBufferToBase64(
                    credentialResponse.signature
                  ),
                  userHandle: EncodingUtils.arrayBufferToBase64(
  ...
  var WebAuthnRegistrationHandler = (function () {
    function WebAuthnRegistrationHandler(
      authSessionId,
      username,
      userDisplayName
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              credentialCreationOptions.excludeCredentials = credentialCreationOptions.excludeCredentials.map(
                function (cred) {
                  return {
  ...
  var WebAuthnSdkImpl = (function () {
    ...
    WebAuthnSdkImpl.prototype._clearSdkSessionState = function (
      retainConfiguration
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (
                !this._currentRegistrationSession ||
                !this._currentRegistrationSession.isReady
              ) {
                throw makeSdkRejection(
                  ErrorCode.MissingPrepareStep,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                2,
                this._currentCrossDeviceSessionHandler.getController()
              ];
          }
        });
      });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4,
                SdkBindIdApiClient.attachDeviceToSession(authSessionId)
              ];
            case 1:
              ...
              return [
                ...
                {
                  bindingMessage:
                    attachDeviceResponse.binding_info.binding_message,
                  originatingDevice: {
                    osType:
                      attachDeviceResponse.binding_info.originating_device
                        .device_info.os_type,
                    osVersion:
                      attachDeviceResponse.binding_info.originating_device
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4,
                SdkBindIdApiClient.detachDeviceFromSession(authSessionId)
              ];
            case 1:
              _a.sent();
              return [2];
