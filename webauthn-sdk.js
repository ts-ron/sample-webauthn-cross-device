    ...
    ***************************************************************************** */
        ...
        AsyncInterval.prototype.resume = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.handler()];
                        case 1:
                            _a.sent();
                            this.timeoutId = globalThis.setTimeout(function () { return _this.resume(); }, this.timeout);
                            return [2];
                    }
                });
            });
    ...
    var SdkStorage = (function () {
        ...
        SdkStorage.get = function (keyName) {
            return SdkStorage.getStorageMedium(SdkStorage.allowedKeys[keyName]).getItem(SdkStorage.getStorageKey(keyName)) || undefined;
        };
        ...
        SdkStorage.clear = function (retainConfiguration) {
            var e_1, _a;
            try {
                for (var _b = __values(Object.entries(SdkStorage.allowedKeys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var _d = __read(_c.value, 2), key = _d[0], keyPersistence = _d[1];
                    var typedKey = key;
                    if ((retainConfiguration && this.configurationKeys.includes(typedKey)) || keyPersistence == KeyPersistance.persistent) {
                        continue;
                    }
        ...
        SdkStorage.getStorageMedium = function (keyPersistance) {
            switch (keyPersistance) {
                case KeyPersistance.persistent: return localStorage;
                case KeyPersistance.session: return sessionStorage;
            }
        };
        SdkStorage.allowedKeys = {
            ...
            'deviceFingerprints': KeyPersistance.persistent,
        };
    ...
    var deviceFingerprintProviders = ['FPJS', 'RiskID'];
    var DeviceFingerprint = (function () {
        function DeviceFingerprint(provider, hash) {
            this.provider = provider;
            this.hash = hash;
        }
        DeviceFingerprint.prototype.stringify = function () {
            return "".concat(this.provider, ":").concat(this.hash);
        };
        DeviceFingerprint.fromStorageEntry = function (entry) {
            var splitted = entry.split(':');
            if (!DeviceFingerprint.isDeviceFingerprintProvider(splitted[0])) {
                throw makeSdkRejection(ErrorCode.Unknown, "Could not identify device fingerprint provider: ".concat(splitted[0]));
            }
            return new DeviceFingerprint(splitted[0], splitted[1]);
        };
        DeviceFingerprint.isDeviceFingerprintProvider = function (provider) {
            return deviceFingerprintProviders.includes(provider);
        };
        return DeviceFingerprint;
    }());

    var DeviceFingerprintHandler = (function () {
        function DeviceFingerprintHandler() {
            var _this = this;
            this._currentDfps = {
                FPJS: new LazyLoaded(function () { return __awaiter(_this, void 0, void 0, function () {
                    var result, _a, reducedComponents;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4, load()];
                            case 1: return [4, (_b.sent()).get()];
                            case 2:
                                result = (_b.sent());
                                _a = result.components, _a.fonts, _a.fontPreferences, _a.domBlockers, _a.forcedColors, _a.invertedColors, _a.hdr, _a.monochrome, _a.plugins, _a.reducedMotion, reducedComponents = __rest(_a, ["fonts", "fontPreferences", "domBlockers", "forcedColors", "invertedColors", "hdr", "monochrome", "plugins", "reducedMotion"]);
                                return [2, new DeviceFingerprint('FPJS', hashComponents(reducedComponents))];
                        }
                    });
                }); }),
                RiskID: new LazyLoaded(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        throw makeSdkRejection(ErrorCode.Unknown, "Unsupported device fingerprint provider: RiskID");
                    });
                }); })
            };
        }
        DeviceFingerprintHandler.prototype.getCurrentFingerprint = function (provider) {
            if (provider === void 0) { provider = 'FPJS'; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this._currentDfps[provider].get()];
                        case 1: return [2, _a.sent()];
                    }
                });
            });
        };
        DeviceFingerprintHandler.prototype.getStoredFingerprints = function () {
            var _a;
            return JSON.parse((_a = SdkStorage.get('deviceFingerprints')) !== null && _a !== void 0 ? _a : '[]');
        };
        DeviceFingerprintHandler.prototype.getStoredFingerprint = function (provider) {
            if (provider === void 0) { provider = 'FPJS'; }
            return this.getStoredFingerprints().find(function (dfp) { return dfp.provider === provider; });
        };
        DeviceFingerprintHandler.prototype.persist = function (provider) {
            if (provider === void 0) { provider = 'FPJS'; }
            return __awaiter(this, void 0, void 0, function () {
                var currentDfp, storedFingerprints;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.getCurrentFingerprint(provider)];
                        case 1:
                            currentDfp = _a.sent();
                            storedFingerprints = this.getStoredFingerprints();
                            storedFingerprints = storedFingerprints.filter(function (dfp) { return dfp.provider !== currentDfp.provider; }).concat(currentDfp);
                            SdkStorage.set('deviceFingerprints', JSON.stringify(storedFingerprints.map(function (dfp) { return dfp.stringify(); })));
                            return [2];
                    }
                });
            });
        };
        return DeviceFingerprintHandler;
    }());
    var deviceFingerprintHandler = new DeviceFingerprintHandler();
    ...
    var SdkBindIdApiClient = (function () {
        ...
        SdkBindIdApiClient.init = function (serverPath) {
            try {
                this._serverPath = new URL(serverPath);
            }
            catch (error) {
                throw makeSdkRejection(ErrorCode.NotInitialized, "Invalid options.serverPath", { error: error });
            }
        };
        SdkBindIdApiClient.sendRequest = function (path, request, metadata) {
            return __awaiter(this, void 0, void 0, function () {
                var deviceBindingToken, deviceFingerprint, requestUrl, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            logger.log("[WebAuthn SDK] Calling ".concat(request.method, " ").concat(path, "..."));
                            deviceBindingToken = SdkStorage.get("deviceBindingToken");
                            return [4, deviceFingerprintHandler.getCurrentFingerprint()];
                        case 1:
                            deviceFingerprint = (_a.sent()).stringify();
                            requestUrl = new URL(this._serverPath);
                            requestUrl.pathname += path;
                            return [4, fetch(requestUrl.toString(), __assign(__assign({}, request), { headers: __assign(__assign(__assign(__assign({}, request.headers), (metadata.authSessionId && {
                                        "x-ts-flow-id": metadata.authSessionId,
                                    })), (deviceBindingToken && {
                                        "x-ts-device-binding-token": deviceBindingToken,
                                    })), { "x-ts-device-fingerprint": deviceFingerprint }) }))];
                        case 2:
                            response = _a.sent();
                            if (response.headers.has("set-device-binding-token")) {
                                SdkStorage.set("deviceBindingToken", response.headers.get("set-device-binding-token"));
                            }
                            return [2, response];
                    }
                });
        ...
        SdkBindIdApiClient.startRestrictedSession = function (clientId, crossDeviceBindingMessage) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/auth-session/start-restricted", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
                                body: JSON.stringify(__assign({ client_id: clientId }, (crossDeviceBindingMessage && {
                                    cross_device: {
        ...
        SdkBindIdApiClient.startWebauthnRegistration = function (authSessionId, idpUsername, fidoUserDisplayName) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/webauthn/register/start", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.completeWebauthnRegistration = function (authSessionId, webauthnSessionId, encodedCredential) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/webauthn/register/complete", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.startWebauthnAuthentication = function (authSessionId, idpUsername) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/webauthn/authenticate/start", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.completeWebauthnAuthentication = function (authSessionId, webauthnSessionId, encodedCredential) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/webauthn/authenticate/complete", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.getSessionStatus = function (authSessionId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/auth-session/status", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.attachDeviceToSession = function (authSessionId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/auth-session/attach-device", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
        ...
        SdkBindIdApiClient.detachDeviceFromSession = function (authSessionId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.sendRequest("v1/auth-session/detach-device", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                },
    ...
    var CrossDeviceSessionHandler = (function () {
        function CrossDeviceSessionHandler(authSessionId, handlers) {
            ...
            this._interval = new AsyncInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_o) {
                    switch (_o.label) {
                        ...
                        case 1:
                            ...
                            if (!(this._lastSessionStatus.cross_device_status != currentSessionStatus.cross_device_status)) return [3, 11];
                            handlerResult = void 0;
                            if (!(currentSessionStatus.cross_device_status == 'pending-attachment')) return [3, 2];
                            logger.log('cross_device_status was updated to pending-attachment. this should never happen.');
                            return [3, 10];
                        case 2:
                            if (!(currentSessionStatus.cross_device_status == 'attached')) return [3, 4];
                            return [4, ((_b = (_a = this.handlers).onDeviceAttach) === null || _b === void 0 ? void 0 : _b.call(_a))];
                        case 3:
                            handlerResult = _o.sent();
                            return [3, 10];
                        case 4:
                            if (!(currentSessionStatus.cross_device_status == 'registered')) return [3, 6];
                            return [4, ((_d = (_c = this.handlers).onCredentialRegister) === null || _d === void 0 ? void 0 : _d.call(_c, (_e = currentSessionStatus.cross_device_result) === null || _e === void 0 ? void 0 : _e.auth_code))];
                        case 5:
                            handlerResult = _o.sent();
                            return [3, 10];
                        case 6:
                            if (!(currentSessionStatus.cross_device_status == 'authenticated')) return [3, 8];
                            return [4, ((_g = (_f = this.handlers).onCredentialAuthenticate) === null || _g === void 0 ? void 0 : _g.call(_f, (_h = currentSessionStatus.cross_device_result) === null || _h === void 0 ? void 0 : _h.auth_code))];
                        case 7:
                            handlerResult = _o.sent();
                            return [3, 10];
                        case 8:
                            if (!(currentSessionStatus.cross_device_status == 'completed')) return [3, 10];
                            return [4, ((_k = (_j = this.handlers).onDeviceDetach) === null || _k === void 0 ? void 0 : _k.call(_j))];
                        case 9:
                            handlerResult = _o.sent();
                            _o.label = 10;
                        case 10:
                        ...
                        case 12:
                            ...
                            this.destroy();
                            (_m = (_l = this.handlers).onFailure) === null || _m === void 0 ? void 0 : _m.call(_l, ErrorCode.Unknown);
                            return [3, 13];
                        case 13: return [2];
                    }
                });
    ...
    var DeviceUsers = (function () {
        ...
        DeviceUsers.get = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    return [2, JSON.parse((_a = SdkStorage.get("deviceUsers")) !== null && _a !== void 0 ? _a : '[]')];
                });
            });
        };
        DeviceUsers.persist = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, DeviceUsers.get()];
                        case 1:
                            usersList = _a.sent();
                            usersList = usersList.map(function (deviceUser) { return { username: deviceUser.username, isCurrent: false }; });
                            usersList = __spreadArray([{ username: username, isCurrent: true }], __read(usersList.filter(function (deviceUser) { return deviceUser.username != username; })), false);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            usersList = _a.sent();
                            usersList = usersList.filter(function (deviceUser) { return deviceUser.username != username; });
                            SdkStorage.set('deviceUsers', JSON.stringify(usersList));
                            return [2];
                    }
                });
    ...
    var EncodingUtils = (function () {
        ...
        EncodingUtils.arrayBufferToBase64 = function (buffer) {
            return btoa(String.fromCharCode.apply(String, __spreadArray([], __read(new Uint8Array(buffer)), false)));
        };
    ...
    var WebAuthnAuthenticationHandler = (function () {
        function WebAuthnAuthenticationHandler(authSessionId, username) {
            ...
            this.startAuthenticationResponse = new LazyLoaded(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, SdkBindIdApiClient.startWebauthnAuthentication(this.authSessionId, username)];
                        case 1: return [2, _a.sent()];
                    }
                });
            }); });
        ...
        WebAuthnAuthenticationHandler.prototype.prepare = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.startAuthenticationResponse.get()];
                        case 1:
                            _a.sent();
                            return [2];
                    }
        ...
        WebAuthnAuthenticationHandler.prototype.execute = function () {
            return __awaiter(this, void 0, void 0, function () {
                var startAuthenticationResponse, credentialRequestOptions, credential, credentialResponse, encodedCredential, completeAuthenticationResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.startAuthenticationResponse.get()];
                        case 1:
                            ...
                            credentialRequestOptions.challenge = EncodingUtils.base64ToArrayBuffer(credentialRequestOptions.challenge);
                            credentialRequestOptions.allowCredentials = credentialRequestOptions.allowCredentials.map(function (ac) { return (__assign(__assign({}, ac), { id: EncodingUtils.base64ToArrayBuffer(ac.id) })); });
                        ...
                        case 2:
                            ...
                            return [4, SdkBindIdApiClient.completeWebauthnAuthentication(this.authSessionId, startAuthenticationResponse.webauthn_session_id, encodedCredential)];
                        case 3:
                            ...
                            deviceFingerprintHandler.persist();
                            return [2];
                    }
                });
            });
    ...
    var WebAuthnRegistrationHandler = (function () {
        function WebAuthnRegistrationHandler(authSessionId, username, userDisplayName) {
            ...
            this.authSessionId = authSessionId;
            this.username = username;
            this.startRegistrationResponse = new LazyLoaded(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, SdkBindIdApiClient.startWebauthnRegistration(this.authSessionId, username, userDisplayName)];
                        case 1: return [2, _a.sent()];
                    }
                });
            }); });
        ...
        WebAuthnRegistrationHandler.prototype.prepare = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.startRegistrationResponse.get()];
                        case 1:
                            _a.sent();
                            return [2];
                    }
        ...
        WebAuthnRegistrationHandler.prototype.execute = function () {
            return __awaiter(this, void 0, void 0, function () {
                var startRegistrationResponse, credentialCreationOptions, credential, credentialResponse, encodedCredential, completeRegistrationResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.startRegistrationResponse.get()];
                        case 1:
                            ...
                            credentialCreationOptions.challenge = EncodingUtils.base64ToArrayBuffer(credentialCreationOptions.challenge);
                            credentialCreationOptions.user.id = EncodingUtils.base64ToArrayBuffer(credentialCreationOptions.user.id);
                            credentialCreationOptions.excludeCredentials = credentialCreationOptions.excludeCredentials.map(function (cred) { return ({
                                id: EncodingUtils.base64ToArrayBuffer(cred.id),
                                type: cred.type
                            }); });
                        ...
                        case 2:
                            ...
                            return [4, SdkBindIdApiClient.completeWebauthnRegistration(this.authSessionId, startRegistrationResponse.webauthn_session_id, encodedCredential)];
                        case 3:
    ...
    var WebAuthnSdkImpl = (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        SdkBindIdApiClient.init(options.serverPath);
                        if (!clientId) {
                            throw makeSdkRejection(ErrorCode.NotInitialized, 'Invalid clientId', { clientId: clientId });
                        }
                        ...
                        if (isSdkRejection(error)) {
                            ...
                            throw makeSdkRejection(ErrorCode.NotInitialized, 'Something went wrong', { error: error });
                        }
                    }
                    return [2];
                });
        ...
        WebAuthnSdkImpl.prototype.prepareWebauthnRegistration = function (username, displayName, authSessionId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this._initialized) {
                                throw makeSdkRejection(ErrorCode.NotInitialized);
                            }
                            if (authSessionId) {
                                ...
                                if (!authSessionId) {
                                    throw makeSdkRejection(ErrorCode.InvalidAuthSession, "authSessionId was not provided");
                                }
                            }
                            this._currentRegistrationSession = new WebAuthnRegistrationHandler(authSessionId, username, displayName !== null && displayName !== void 0 ? displayName : username);
                            return [4, this._currentRegistrationSession.prepare()];
                        case 1: return [2, _a.sent()];
                    }
                });
            });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!this._currentRegistrationSession || !this._currentRegistrationSession.isReady) {
                                throw makeSdkRejection(ErrorCode.MissingPrepareStep, "executeWebauthnRegistration() cannot be called before prepareWebauthnRegistration() has completed successfully");
                            }
                            return [4, this._currentRegistrationSession.execute()];
                        case 1:
                            _a.sent();
        ...
        WebAuthnSdkImpl.prototype.prepareWebauthnAuthentication = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                var authSessionId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            authSessionId = SdkStorage.get('authSessionId');
                            if (!!authSessionId) return [3, 2];
                            return [4, SdkBindIdApiClient.startRestrictedSession(SdkStorage.get("clientId"))];
                        case 1:
                            (authSessionId = (_a.sent()).auth_session_id);
                            SdkStorage.set('authSessionId', authSessionId);
                            _a.label = 2;
                        case 2:
                            this._currentAuthenticationSession = new WebAuthnAuthenticationHandler(authSessionId, username);
                            return [4, this._currentAuthenticationSession.prepare()];
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!this._currentAuthenticationSession) {
                                throw makeSdkRejection(ErrorCode.MissingPrepareStep, "executeWebauthnAuthentication() cannot be called before prepareWebauthnAuthentication() has completed successfully");
                            }
        ...
        WebAuthnSdkImpl.prototype.startCrossDeviceFlow = function (handlers, bindingMessage) {
            return __awaiter(this, void 0, void 0, function () {
                var authSessionId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this._currentRegistrationSession = undefined;
                            this._currentAuthenticationSession = undefined;
                            return [4, SdkBindIdApiClient.startRestrictedSession(SdkStorage.get("clientId"), bindingMessage)];
                        case 1:
                            authSessionId = (_a.sent()).auth_session_id;
                            SdkStorage.set('authSessionId', authSessionId);
                            this._currentCrossDeviceSessionHandler = new CrossDeviceSessionHandler(authSessionId, handlers);
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2, {
                                    ...
                                    originatingDevice: {
                                        osType: attachDeviceResponse.binding_info.originating_device.device_info.os_type,
                                        osVersion: attachDeviceResponse.binding_info.originating_device.device_info.os_version,
                                        browserType: attachDeviceResponse.binding_info.originating_device.device_info.browser_type,
                                        browserVersion: attachDeviceResponse.binding_info.originating_device.device_info.browser_version,
                                    }
                                }];
                    }
                });
    ...
    exports.WebAuthnSdkImpl = WebAuthnSdkImpl;
